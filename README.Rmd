...
[![Website deployment](https://github.com/ropensci/forcis/actions/workflows/pkgdown.yaml/badge.svg)](https://github.com/ropensci/forcis/actions/workflows/pkgdown.yaml)
...
- the [Get started](https://ropensci.github.io/forcis/articles/forcis.html) vignette describes the core features of the package
...
- the [Select and filter data](https://ropensci.github.io/forcis/articles/select-and-filter-data.html) vignette shows examples to handle the FORCIS data
...
> Casajus N, Greco M, Chaabane S, Giraud X & de Garidel-Thoron T (2024) forcis: An R client to access the FORCIS database. R package version 0.1.0.9000. URL: https://ropensci.github.io/forcis/.
