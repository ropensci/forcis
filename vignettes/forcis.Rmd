...
**N.B.** The package `forcis` is designed to handle the versioning of the database on Zenodo. Read the [Database versions](https://ropensci.github.io/forcis/articles/database-versions.html) for more information.
...
The [Data visualization](https://ropensci.github.io/forcis/articles/data-visualization.html) vignette provides a complete description of all plotting functions available in `forcis`.
...
The [Select, reshape, and filter data](https://ropensci.github.io/forcis/articles/select-and-filter-data.html) vignette shows examples to handle FORCIS data.

## To go further

Additional vignettes are available depending on user wishes:

- the [Database versions](https://ropensci.github.io/forcis/articles/database-versions.html) vignette provides information on how to deal with the versioning of the database
- the [Select, reshape, and filter data](https://ropensci.github.io/forcis/articles/select-and-filter-data.html) vignette shows examples to select, filter and reshape the FORCIS data
- the [Data conversion](https://ropensci.github.io/forcis/articles/data-conversion.html) vignette describes the conversion functions available in `forcis` to compute abundances, concentrations, and frequencies
- the [Data visualization](https://ropensci.github.io/forcis/articles/data-visualization.html) vignette describes the plotting functions available in `forcis`
