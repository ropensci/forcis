...
The package `forcis` provides [numerous functions](https://ropensci.github.io/forcis/reference/index.html#visualization-tools) to visualize FORCIS data. This vignette shows how to use and customize these functions.
